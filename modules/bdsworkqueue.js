...
export class BDSWorkqueue {
  ...
  //   let wklist = `<ul class="collection z-depth-1">`;
  //   wklist += `
  ...
  //   this.userfiles = JSON.parse(localStorage.getItem(`userfiles`));
  //   document.getElementById("bdscontent").innerHTML = `
  //     <div id="bufiles" style="overflow:scroll;height:75vh;margin:0em;">${this.DisplayWorkqueueList(keyword)}</div>
  //     <div id="cofiles" style="overflow:scroll;height:75vh;margin:0em;"><bds-onix-create></bds-onix-create></div>
  //   `;
